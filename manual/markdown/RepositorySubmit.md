...
//------------------------------------------------ //--- 010 Editor v7.0 Binary Template // // File: Test.bt // Authors: SweetScape Software // Version: 1.0 // Purpose: This is a test template. // Category: Misc // File Mask: *.test // ID Bytes: 3F FF // History: // 1.0 2016-03-04 SweetScape Software: Initial release. //------------------------------------------------ RequiresVersion(7); Most of this information must be entered using the editor; however, the Submit dialog contains some fields which make adding a Category or History item easier. The different sections of the header are described below:
